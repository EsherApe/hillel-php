...
<div class="main-contaner clearfix">
    <div class="col-xs-12">
        ...
        <article class="publication-item">
            <h3 class="text-center"><?= $articles[$index]['title'] ?> <br></h3>
            <div class="publication-header clearfix">
                <i>Article № <?= $articles[$index]['id'] ?></i>
                <i class="pull-right">Author: <?= $articles[$index]['author'] ?></i>
            </div>
            <div class="text-center">
                <?= $articles[$index]['long_text'] ?><br>
            </div>
